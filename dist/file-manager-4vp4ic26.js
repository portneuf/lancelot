...
import { i as saveInspection } from "./inspection-db-D9IlUciM.js";
import { Suspense, createContext, lazy, useCallback, useContext, useRef, useState } from "react";
import { FileWarning, Loader2, Upload, Wand2 } from "lucide-react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import * as SliderPrimitive from "@radix-ui/react-slider";
import { useNavigate } from "react-router";
import * as Dialog from "@radix-ui/react-dialog";
//#region src/mode-context.tsx
var LancelotModeContext = /* @__PURE__ */ createContext({
	mode: "standalone",
	basePath: "/"
});
function useLancelotMode() {
...
*/
/** Maps flat view keys to standalone nested routes. */ var STANDALONE_ROUTES = {
	"files": "/file/open",
	"file-info": "/file/info",
	"wafer-map": "/wafer/map",
...
*/ function useLancelotNavigate() {
	...
	return useCallback((viewKey) => {
		if (mode === "standalone") navigate(STANDALONE_ROUTES[viewKey] ?? `/${viewKey}`);
		else navigate(`${basePath.endsWith("/") ? basePath : `${basePath}/`}${viewKey}`);
	}, [
		navigate,
		mode,
		basePath
...
var InspectionHistory = /* @__PURE__ */ lazy(() => import("./InspectionHistory-BsWkxMc0.js"));
...
//# sourceMappingURL=file-manager-4vp4ic26.js.map