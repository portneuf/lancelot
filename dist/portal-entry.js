...
import { Activity, BarChart3, Brain, CircleDot, FileText, FolderOpen, GitCompare, Hexagon, Layers, LayoutGrid, LineChart, ScatterChart, Slash, Table, Tags, TrendingUp } from "lucide-react";
...
*/ var lancelotRegistration = {
	...
	treeComponent: lazy(() => import("./LancelotFileTree-CAV_PJxE.js")),
...
var messages$6 = {
	...
	"batch.description": "Select a directory to import all KLARF and SINF files.",
	"batch.importDirectory": "Batch Import",
	"batch.selectDirectory": "Select Directory",
	"batch.scanning": "Scanning directory...",
	"batch.reading": "Reading",
	"batch.parsing": "Parsing",
	"batch.succeeded": "succeeded",
	"batch.failed": "failed",
	"batch.total": "total",
	"db.title": "Database",
	"db.modeMemory": "In-Memory (Default)",
	"db.modeMemoryDesc": "Files are stored in memory only. No persistence between sessions.",
	"db.modeRemote": "PostgreSQL Server",
	"db.modeRemoteDesc": "Connect to a PostgreSQL database for persistent storage and lot-spanning analysis.",
	"db.host": "Host",
	"db.port": "Port",
	...
	"db.activeConnection": "Database connection is active",
...
var messages$5 = {
	...
	"nav.stacking": "Stacking",
	"stacking.title": "Wafer-Stacking",
	"stacking.openFilesToView": "Laden Sie KLARF-Dateien für Stacking-Analyse",
	"stacking.aggregation": "Aggregation",
	"stacking.density": "Defektdichte",
	"stacking.hitCount": "Wafer-Trefferanzahl",
	"stacking.classDominance": "Klassendominanz",
	"stacking.gridSize": "Rastergröße",
	"stacking.wafers": "Wafer",
	"stacking.selectAll": "Alle auswählen",
	"stacking.deselectAll": "Alle abwählen",
