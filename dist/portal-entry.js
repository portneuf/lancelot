import { n as setPortalMode } from "./mode-flag-BCQ2AIxi.js";
...
*/ var lancelotViews = [
	{
		path: "files",
		component: lazy(() => import("./file-manager-4vp4ic26.js")),
		navItem: {
			type: "link",
			group: "files",
			icon: FolderOpen,
	...
	{
		path: "file-info",
		component: lazy(() => import("./file-info-FM_GCGE5.js")),
		navItem: {
			type: "link",
			group: "files",
			icon: FileText,
	...
	{
		path: "wafer-map",
		component: lazy(() => import("./wafer-map-C13iMoNC.js")),
		navItem: {
			type: "link",
			group: "views",
			icon: Hexagon,
	...
	{
		path: "defect-table",
		component: lazy(() => import("./defects-DYXSsnFN.js")),
		navItem: {
			type: "link",
			group: "views",
			icon: Table,
	...
	{
		path: "classes",
		component: lazy(() => import("./classes-X-GMJvc5.js")),
		navItem: {
			type: "link",
			group: "views",
			icon: Tags,
	...
	{
		path: "pareto",
		component: lazy(() => import("./pareto-B1264LmP.js")),
		navItem: {
			type: "link",
			group: "views",
			icon: BarChart3,
	...
	{
		path: "spatial",
		component: lazy(() => import("./spatial-CfvBSpDV.js")),
		navItem: {
			type: "link",
			group: "views",
			icon: ScatterChart,
	...
	{
		path: "yield",
		component: lazy(() => import("./yield-BNhu7KC2.js")),
		navItem: {
			type: "link",
			group: "views",
			icon: TrendingUp,
	...
	{
		path: "correlation",
		component: lazy(() => import("./correlation-6BR2r0E0.js")),
		navItem: {
			type: "link",
			group: "views",
			icon: GitCompare,
	...
	{
		path: "trend",
		component: lazy(() => import("./trend-Csg0aB76.js")),
		navItem: {
			type: "link",
			group: "views",
			icon: LineChart,
...
*/ var lancelotRegistration = {
	...
	globalFilters: lazy(() => import("./LancelotFilters-jLh4tZjx.js")),
	statusBarSlots: [{
...
var lancelotTranslations = {
	en: prefixKeys(messages$4),
	de: prefixKeys(messages$3),
