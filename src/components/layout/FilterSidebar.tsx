      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {file.classLookup.length > 0 && (
          <div className="border-b border-border px-3 py-3">
            <span className="mb-2 block text-xs font-medium text-muted-foreground">Defect Class</span>
        ...
        {/* Search */}
        <div className="border-b border-border px-3 py-3">
          <span className="mb-2 block text-xs font-medium text-muted-foreground">Search</span>
          <input
            type="text"
